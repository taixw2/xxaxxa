...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    unmannedMYTAuthUserSubject.add(
      UnmannedMYTAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<UnmannedMYTAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  UnmannedMYTAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = UnmannedMYTAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    unmannedMYTAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
UnmannedMYTAuthUser? currentUser;
