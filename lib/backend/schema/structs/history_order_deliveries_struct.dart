...
class HistoryOrderDeliveriesStruct extends BaseStruct {
  HistoryOrderDeliveriesStruct({
    int? logisticMode,
    int? cancelTime,
    String? sourceNo,
    String? deliveryName,
  ...
  static HistoryOrderDeliveriesStruct fromMap(Map<String, dynamic> data) =>
      HistoryOrderDeliveriesStruct(
  ...
  static HistoryOrderDeliveriesStruct? maybeFromMap(dynamic data) => data is Map
      ? HistoryOrderDeliveriesStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static HistoryOrderDeliveriesStruct fromSerializableMap(
  ...
  @override
  String toString() => 'HistoryOrderDeliveriesStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is HistoryOrderDeliveriesStruct &&
...
HistoryOrderDeliveriesStruct createHistoryOrderDeliveriesStruct({
  int? logisticMode,
  int? cancelTime,
  String? sourceNo,
  String? deliveryName,
