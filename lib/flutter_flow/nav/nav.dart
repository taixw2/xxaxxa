...
class AppStateNotifier extends ChangeNotifier {
  ...
  UnmannedMYTAuthUser? initialUser;
  UnmannedMYTAuthUser? user;
  ...
  void update(UnmannedMYTAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'InStorePage',
          path: '/inStorePage',
          builder: (context, params) => InStorePageWidget(
        ...
        FFRoute(
          name: 'FeaturePage',
          path: '/featurePage',
          builder: (context, params) => FeaturePageWidget(
            warehouseId: params.getParam(
              'warehouseId',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: 'SearchGoods',
          path: '/searchGoods',
          builder: (context, params) => SearchGoodsWidget(
            warehouseId: params.getParam(
              'warehouseId',
              ParamType.String,
            ),
